...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white overflow-hidden relative">
      {/* Wave decoration */}
      <div className="absolute top-0 left-0 right-0 h-6 bg-green-600 opacity-10 transform -skew-y-1"></div>
      ...
      <div className="max-w-7xl mx-auto pt-16 pb-8 px-6 relative z-10">
        ...
        <div className="pt-10 mt-10 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Doro Foods LLC. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0">
            <Link
              to="/privacy"
              className="text-gray-400 hover:text-white text-sm mx-3 transition"
            >
              Privacy Policy
            </Link>
            <Link
